<!-- fixed-top-->
<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-dark navbar-border navbar-brand-center">
                ...
                <li class="nav-item">
                    ...
                    <?php if ($user['role_id'] == 1) : ?>
                        <a class="navbar-brand" href="<?= base_url(); ?>/master">
                            <img class="brand-logo" alt="stack admin logo" src="<?= base_url(); ?>assets/images/logo/increasing-bar-graph.png" style="width: 30px;">
                            <h2 class="brand-text">SIPOLIN</h2>
                        </a>
        ...
        <div class="navbar-container container center-layout">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="ficon ft-award"></i></a>
                        <ul class="mega-dropdown-menu dropdown-menu row">
                            <li class="col-md-2">
                                <h6 class="dropdown-menu-header text-uppercase mb-1"><i class="fa fa-newspaper-o"></i> News</h6>
                                <div id="mega-menu-carousel-example">
                                    <div>
                                        <img class="rounded img-fluid mb-1" src="<?= base_url(); ?>assets/images/slider/slider-2.png" alt="First slide"><a class="news-title mb-0" href="#">Poster Frame PSD</a>
                            ...
                            <li class="scrollable-container media-list">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-online rounded-circle">
                                                <img src="<?= base_url(); ?>assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-busy rounded-circle">
                                                <img src="<?= base_url(); ?>assets/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-online rounded-circle">
                                                <img src="<?= base_url(); ?>assets/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-away rounded-circle">
                                                <img src="<?= base_url(); ?>assets/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="avatar avatar-online">
                                <img class="avatar avatar-sm rounded-circle" src="<?= base_url(); ?>assets/images/profile/<?= $user['image']; ?>" alt="avatar"><i></i></span>
                            <span class="user-name"><?= $user['nama_akun']; ?></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="<?= base_url(); ?>user/dataPribadi"><i class="ft-user"></i> Ubah Data Pribadi</a>
                            <a class="dropdown-item" href="<?= base_url(); ?>user/ubahProfil"><i class="ft-image"></i> Ganti Foto</a>                            
